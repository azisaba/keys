...
parallel -C ' ' -a src/mapping.txt '{4} && ln -nfs /opt/resourcepacks {2}/resourcepacks || :'
parallel -C ' ' -a src/mapping.txt '{4} && ln -nfs /opt/minecraft/lgw/plugins {2}/lgwplugins || :'
parallel -C ' ' -a src/mapping.txt '{4} && ln -nfs /opt/minecraft {2}/server || :'
